...
public class List extends API
{
     ...
     * @throws Exception
     */
    public void createFromCampaign(int campaignID, String listName, LogJobStatusArray statuses) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
       values.put("campaignID", String.valueOf(campaignID));
       values.put("listName", listName);
       if (statuses != null) if (statuses != null) values.put("statuses", joinList(statuses));
       uploadValues(API_URI + "/list/createfromcampaign", values, VoidApiResponse.class);
   }
     ...
     * @throws Exception
     */
    public ExportLink export(String listName, ExportFileFormats fileFormat, CompressionFormat compressionFormat, String fileName) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
       values.put("listName", listName);
       ...
       return uploadValues(API_URI + "/list/export", values, ExportLink.class);
   }
     ...
     * @throws Exception
     */
    public ListArray list(Date from, Date to) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
       if (from != null) values.put("from", String.valueOf(from));
       if (to != null) values.put("to", String.valueOf(to));
       return uploadValues(API_URI + "/list/list", values, ListArray.class);
   }
     ...
     * @throws Exception
     */
    public void moveContacts(String oldListName, String newListName, StringArray emails, Boolean moveAll, ContactStatusArray statuses, String rule) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
     ...
     * @throws Exception
     */
    public void update(String listName, String newListName, Boolean allowUnsubscribe, Boolean trackHistory) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
       values.put("listName", listName);
       values.put("newListName", newListName);
