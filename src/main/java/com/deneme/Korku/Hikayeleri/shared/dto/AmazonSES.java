...
public class AmazonSES {
    ...
    final String FROM = "softwareoffear@gmail.com";

    // The subject line for the email.
    final String SUBJECT = "Korku Hikayelerine ulaşmanız için son bir adım kaldı.";
    ...
    final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
            ...
            + "<a href='http://ec2-52-59-205-203.eu-central-1.compute.amazonaws.com:8080/verification-service/password-reset.html?token=$tokenValue'>"
